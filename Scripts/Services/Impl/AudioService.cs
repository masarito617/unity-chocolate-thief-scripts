...
namespace Chocolate.Services.Impl
{
    public class AudioService : IAudioService
    {
        ...
        /// Audio情報
        /// </summary>
        private readonly Dictionary<GameAudioType, AudioInfo> _audioInfos;

        public AudioService(PlayerPrefsRepository playerPrefsRepository)
        {
            // オーディオ情報を登録
            _audioInfos = GameAudioUtil.GetAudioInfos();
        ...
        private GameAudioType GetReversiAudioType(string name)
        {
        ...
        /// 効果音再生
        /// </summary>
        public void PlayOneShot(GameAudioType audioType)
        {
        ...
        private AudioClip LoadAudioClip(GameAudioType audioType)
        {
            // ファイル名をキーとしてキャッシュする
